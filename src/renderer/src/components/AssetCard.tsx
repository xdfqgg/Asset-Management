...
// 资产卡片：缩略图（带状态占位）+ 文件名
export default function AssetCard({ asset, size }: { asset: AssetRow; size: number }): JSX.Element {
  ...
  return (
    <div className="overflow-hidden rounded-lg border border-border bg-card" style={{ width: size }}>
